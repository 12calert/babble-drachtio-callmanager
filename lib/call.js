...
class call {
  ...
  */
  ...
  /**
    ...
    @param { RegExp } [match] - reg exp matching what is required from the user.
    @param { number } [timeout] - time to wait before giving up.
    @return {boolean } - the promise either resolves to a string if it matches or undefined if it times out..
  */
  ...
  */
  ...
  @param { RegExp } constraints - event to filter for from our RTP server - excluding DTMF events - these will always return
  */
  ...
  */
  _cleanup() {
    ...
    this.removealllisteners( undefined )
  }
  ...
  */
  ...
  @param { object } options.auth - SIP auth
  ...
  @param { object } options.entity - used to store this call against and look up a contact string if not supplied.
